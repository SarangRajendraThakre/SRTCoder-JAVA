...
public class SpringBoot2SetterConstructorInjectionApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext container = SpringApplication.run(SpringBoot2SetterConstructorInjectionApplication.class,
				args);
