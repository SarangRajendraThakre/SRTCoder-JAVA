...
public class P91_Str_GST_Validation {


    public static void main(String[] args) {

        System.out.println("Enter the GST No:");
        Scanner sc = new Scanner(System.in);
        String str = sc.nextLine();

        // 3. Check the boolean result and print a message
        if (isPanCardValid(str)) {
            System.out.println("'" + str + "' is a valid GST No");
        } else {
            System.out.println("'" + str + "' is an invalid  GST");
        }
