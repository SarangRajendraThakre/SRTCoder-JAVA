 ...
 * It uses encapsulation by keeping fields private.
 */
class Account {
    ...
    // Public "getter" methods to safely access private data
...
/**
 * The Bank class manages the bank's information and contains the Account object.
 * This demonstrates the "has-a" relationship (Composition).
 */
class Bank {
    ...
    public void checkBalance(int inputPin) {
        ...
        if (inputPin == this.account.getPin()) {
            ...
            // Using printf with the correct format specifier
 ...
 */
public class P24_Encapsulation_Compositon_BankingDriver{
    public static void main(String[] args) {
        ...
        // 2. The bank creates a hardcoded account for a customer
